...
# Load data
world = gpd.read_file("/mount/src/antipodle/backend/ne_10m_admin_0_countries.shp")
world = world.to_crs(epsg=4326)
iso_df = pd.read_csv("/mount/src/antipodle/backend/ISO Codes.csv")  # Must contain columns: 'Code' and 'Name'
